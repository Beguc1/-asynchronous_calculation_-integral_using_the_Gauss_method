namespace Practica3
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            numLowerLimit.Location = new Point(160, 14);
            ...
            numUpperLimit.Location = new Point(160, 44);
            ...
            numUpperLimit.Value = new decimal(new int[] { 8, 0, 0, 0 });
            //
            // label3
            //
            ...
            // numSegments
            //
            numSegments.Location = new Point(160, 74);
            ...
            numSegments.Size = new Size(105, 23);
            numSegments.TabIndex = 5;
            numSegments.Value = new decimal(new int[] { 1000, 0, 0, 0 });
            //
            // btnCalculate
            //
            btnCalculate.Location = new Point(18, 110);
            btnCalculate.Margin = new Padding(3, 2, 3, 2);
            btnCalculate.Name = "btnCalculate";
            btnCalculate.Size = new Size(247, 30);
            ...
            // progressBar
            //
            progressBar.Location = new Point(18, 150);
            progressBar.Margin = new Padding(3, 2, 3, 2);
            progressBar.Name = "progressBar";
            progressBar.Size = new Size(247, 18);
            progressBar.TabIndex = 7;
            //
            // lblResult
            //
            lblResult.AutoSize = true;
            lblResult.Location = new Point(18, 180);
